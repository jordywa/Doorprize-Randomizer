 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var gp;function x1(){if(gp)return lt;gp=1;var n=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),l=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),f=Symbol.for("react.consumer"),d=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),b=Symbol.iterator;function x(O){return O===null||typeof O!="object"?null:(O=b&&O[b]||O["@@iterator"],typeof O=="function"?O:null)}var A={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,E={};function C(O,P,it){this.props=O,this.context=P,this.refs=E,this.updater=it||A}C.prototype.isReactComponent={},C.prototype.setState=function(O,P){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,P,"setState")},C.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function R(){}R.prototype=C.prototype;function B(O,P,it){this.props=O,this.context=P,this.refs=E,this.updater=it||A}var V=B.prototype=new R;V.constructor=B,T(V,C.prototype),V.isPureReactComponent=!0;var G=Array.isArray,q={H:null,A:null,T:null,S:null},W=Object.prototype.hasOwnProperty;function ot(O,P,it,et,X,ht){return it=ht.ref,{$$typeof:n,type:O,key:P,ref:it!==void 0?it:null,props:ht}}function K(O,P){return ot(O.type,P,void 0,void 0,void 0,O.props)}function j(O){return typeof O=="object"&&O!==null&&O.$$typeof===n}function tt(O){var P={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(it){return P[it]})}var kt=/\/+/g;function Ee(O,P){return typeof O=="object"&&O!==null&&O.key!=null?tt(""+O.key):P.toString(36)}function Oe(){}function De(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(Oe,Oe):(O.status="pending",O.then(function(P){O.status==="pending"&&(O.status="fulfilled",O.value=P)},function(P){O.status==="pending"&&(O.status="rejected",O.reason=P)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function le(O,P,it,et,X){var ht=typeof O;(ht==="undefined"||ht==="boolean")&&(O=null);var st=!1;if(O===null)st=!0;else switch(ht){case"bigint":case"string":case"number":st=!0;break;case"object":switch(O.$$typeof){case n:case i:st=!0;break;case v:return st=O._init,le(st(O._payload),P,it,et,X)}}if(st)return X=X(O),st=et===""?"."+Ee(O,0):et,G(X)?(it="",st!=null&&(it=st.replace(kt,"$&/")+"/"),le(X,P,it,"",function(Pt){return Pt})):X!=null&&(j(X)&&(X=K(X,it+(X.key==null||O&&O.key===X.key?"":(""+X.key).replace(kt,"$&/")+"/")+st)),P.push(X)),1;st=0;var se=et===""?".":et+":";if(G(O))for(var yt=0;yt<O.length;yt++)et=O[yt],ht=se+Ee(et,yt),st+=le(et,P,it,ht,X);else if(yt=x(O),typeof yt=="function")for(O=yt.call(O),yt=0;!(et=O.next()).done;)et=et.value,ht=se+Ee(et,yt++),st+=le(et,P,it,ht,X);else if(ht==="object"){if(typeof O.then=="function")return le(De(O),P,it,et,X);throw P=String(O),Error("Objects are not valid as a React child (found: "+(P==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":P)+"). If you meant to render a collection of children, use an array instead.")}return st}function Y(O,P,it){if(O==null)return O;var et=[],X=0;return le(O,et,"","",function(ht){return P.call(it,ht,X++)}),et}function F(O){if(O._status===-1){var P=O._result;P=P(),P.then(function(it){(O._status===0||O._status===-1)&&(O._status=1,O._result=it)},function(it){(O._status===0||O._status===-1)&&(O._status=2,O._result=it)}),O._status===-1&&(O._status=0,O._result=P)}if(O._status===1)return O._result.default;throw O._result}var J=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var P=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(P))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)};function vt(){}return lt.Children={map:Y,forEach:function(O,P,it){Y(O,function(){P.apply(this,arguments)},it)},count:function(O){var P=0;return Y(O,function(){P++}),P},toArray:function(O){return Y(O,function(P){return P})||[]},only:function(O){if(!j(O))throw Error("React.Children.only expected to receive a single React element child.");return O}},lt.Component=C,lt.Fragment=o,lt.Profiler=u,lt.PureComponent=B,lt.StrictMode=l,lt.Suspense=h,lt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=q,lt.act=function(){throw Error("act(...) is not supported in production builds of React.")},lt.cache=function(O){return function(){return O.apply(null,arguments)}},lt.cloneElement=function(O,P,it){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var et=T({},O.props),X=O.key,ht=void 0;if(P!=null)for(st in P.ref!==void 0&&(ht=void 0),P.key!==void 0&&(X=""+P.key),P)!W.call(P,st)||st==="key"||st==="__self"||st==="__source"||st==="ref"&&P.ref===void 0||(et[st]=P[st]);var st=arguments.length-2;if(st===1)et.children=it;else if(1<st){for(var se=Array(st),yt=0;yt<st;yt++)se[yt]=arguments[yt+2];et.children=se}return ot(O.type,X,void 0,void 0,ht,et)},lt.createContext=function(O){return O={$$typeof:d,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:f,_context:O},O},lt.createElement=function(O,P,it){var et,X={},ht=null;if(P!=null)for(et in P.key!==void 0&&(ht=""+P.key),P)W.call(P,et)&&et!=="key"&&et!=="__self"&&et!=="__source"&&(X[et]=P[et]);var st=arguments.length-2;if(st===1)X.children=it;else if(1<st){for(var se=Array(st),yt=0;yt<st;yt++)se[yt]=arguments[yt+2];X.children=se}if(O&&O.defaultProps)for(et in st=O.defaultProps,st)X[et]===void 0&&(X[et]=st[et]);return ot(O,ht,void 0,void 0,null,X)},lt.createRef=function(){return{current:null}},lt.forwardRef=function(O){return{$$typeof:p,render:O}},lt.isValidElement=j,lt.lazy=function(O){return{$$typeof:v,_payload:{_status:-1,_result:O},_init:F}},lt.memo=function(O,P){return{$$typeof:m,type:O,compare:P===void 0?null:P}},lt.startTransition=function(O){var P=q.T,it={};q.T=it;try{var et=O(),X=q.S;X!==null&&X(it,et),typeof et=="object"&&et!==null&&typeof et.then=="function"&&et.then(vt,J)}catch(ht){J(ht)}finally{q.T=P}},lt.unstable_useCacheRefresh=function(){return q.H.useCacheRefresh()},lt.use=function(O){return q.H.use(O)},lt.useActionState=function(O,P,it){return q.H.useActionState(O,P,it)},lt.useCallback=function(O,P){return q.H.useCallback(O,P)},lt.useContext=function(O){return q.H.useContext(O)},lt.useDebugValue=function(){},lt.useDeferredValue=function(O,P){return q.H.useDeferredValue(O,P)},lt.useEffect=function(O,P){return q.H.useEffect(O,P)},lt.useId=function(){return q.H.useId()},lt.useImperativeHandle=function(O,P,it){return q.H.useImperativeHandle(O,P,it)},lt.useInsertionEffect=function(O,P){return q.H.useInsertionEffect(O,P)},lt.useLayoutEffect=function(O,P){return q.H.useLayoutEffect(O,P)},lt.useMemo=function(O,P){return q.H.useMemo(O,P)},lt.useOptimistic=function(O,P){return q.H.useOptimistic(O,P)},lt.useReducer=function(O,P,it){return q.H.useReducer(O,P,it)},lt.useRef=function(O){return q.H.useRef(O)},lt.useState=function(O){return q.H.useState(O)},lt.useSyncExternalStore=function(O,P,it){return q.H.useSyncExternalStore(O,P,it)},lt.useTransition=function(){return q.H.useTransition()},lt.version="19.0.0",lt}var vp;function Kc(){return vp||(vp=1,ic.exports=x1()),ic.exports}var _=Kc();const bt=v1(_);var rc={exports:{}},Cr={},oc={exports:{}},lc={};/**
 * @license React
...
`+kt+t+Ee}var De=!1;function le(t,e){if(!t||De)return"";De=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var r={DetermineComponentFrameRoot:function(){try{if(e){var H=function(){throw Error()};if(Object.defineProperty(H.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(H,[])}catch(U){var k=U}Reflect.construct(t,[],H)}else{try{H.call()}catch(U){k=U}t.call(H.prototype)}}else{try{throw Error()}catch(U){k=U}(H=t())&&typeof H.catch=="function"&&H.catch(function(){})}}catch(U){if(U&&k&&typeof U.stack=="string")return[U.stack,k.stack]}return[null,null]}};r.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var s=Object.getOwnPropertyDescriptor(r.DetermineComponentFrameRoot,"name");s&&s.configurable&&Object.defineProperty(r.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var c=r.DetermineComponentFrameRoot(),g=c[0],y=c[1];if(g&&y){var S=g.split(`
`),M=y.split(`
...
}`);var vi=Array.from({length:4},function(n,i){return"--TD-pulsate-phase".concat(i+1,"-color")}),XA=function(n){var i,o=Gl(n==null?void 0:n.style,n==null?void 0:n.size),l=o.styles,u=o.fontSize,f=n==null?void 0:n.easing,d=Xl(n==null?void 0:n.speedPlus,"1.2s").animationPeriod,p=function(h){var m={};if(h instanceof Array){for(var v=Kl(h,vi.length),b=0;b<v.length&&!(b>=4);b++)m[vi[b]]=v[b];return m}try{if(typeof h!="string")throw new Error("Color String expected");for(var x=0;x<vi.length;x++)m[vi[x]]=h}catch(A){for(A instanceof Error?console.warn("[".concat(A.message,']: Received "').concat(typeof h,'" instead with value, ').concat(JSON.stringify(h))):console.warn("".concat(JSON.stringify(h),' received in <ThreeDot variant="pulsate" /> indicator cannot be processed. Using default instead!')),x=0;x<vi.length;x++)m[vi[x]]=no}return m}((i=n==null?void 0:n.color)!==null&&i!==void 0?i:"");return bt.createElement("span",{className:"rli-d-i-b pulsate-rli-bounding-box",style:xt(xt(xt(xt(xt({},u&&{fontSize:u}),d&&{"--rli-animation-duration":d}),f&&{"--rli-animation-function":f}),p),l),role:"status","aria-live":"polite","aria-label":"Loading"},bt.createElement("span",{className:"rli-d-i-b pulsate-indicator"},bt.createElement("span",{className:"rli-d-i-b pulsate-dot"}),bt.createElement("span",{className:"rli-d-i-b pulsate-dot"}),bt.createElement("span",{className:"rli-d-i-b pulsate-dot"})),bt.createElement(Zl,{staticText:!0,text:n==null?void 0:n.text,textColor:n==null?void 0:n.textColor}))};Kt(`.brick-stack-rli-bounding-box {
...
}`);var yi=Array.from({length:4},function(n,i){return"--TD-brick-stack-phase".concat(i+1,"-color")}),GA=function(n){var i,o=Gl(n==null?void 0:n.style,n==null?void 0:n.size),l=o.styles,u=o.fontSize,f=n==null?void 0:n.easing,d=Xl(n==null?void 0:n.speedPlus,"1s").animationPeriod,p=function(h){var m={};if(h instanceof Array){for(var v=Kl(h,yi.length),b=0;b<v.length&&!(b>=4);b++)m[yi[b]]=v[b];return m}try{if(typeof h!="string")throw new Error("Color String expected");for(var x=0;x<yi.length;x++)m[yi[x]]=h}catch(A){for(A instanceof Error?console.warn("[".concat(A.message,']: Received "').concat(typeof h,'" instead with value, ').concat(JSON.stringify(h))):console.warn("".concat(JSON.stringify(h),' received in <ThreeDot variant="brick-stack" /> indicator cannot be processed. Using default instead!')),x=0;x<yi.length;x++)m[yi[x]]=no}return m}((i=n==null?void 0:n.color)!==null&&i!==void 0?i:"");return bt.createElement("span",{className:"rli-d-i-b brick-stack-rli-bounding-box",style:xt(xt(xt(xt(xt({},u&&{fontSize:u}),d&&{"--rli-animation-duration":d}),f&&{"--rli-animation-function":f}),p),l),role:"status","aria-live":"polite","aria-label":"Loading"},bt.createElement("span",{className:"rli-d-i-b brick-stack-indicator"},bt.createElement("span",{className:"rli-d-i-b brick-stack"})),bt.createElement(Zl,{staticText:!0,text:n==null?void 0:n.text,textColor:n==null?void 0:n.textColor}))};Kt(`.bob-rli-bounding-box {
...
}`);var bi=Array.from({length:4},function(n,i){return"--TD-bob-phase".concat(i+1,"-color")}),ZA=function(n){var i,o=Gl(n==null?void 0:n.style,n==null?void 0:n.size),l=o.styles,u=o.fontSize,f=n==null?void 0:n.easing,d=Xl(n==null?void 0:n.speedPlus,"1.2s").animationPeriod,p=function(h){var m={};if(h instanceof Array){for(var v=Kl(h,bi.length),b=0;b<v.length&&!(b>=4);b++)m[bi[b]]=v[b];return m}try{if(typeof h!="string")throw new Error("Color String expected");for(var x=0;x<bi.length;x++)m[bi[x]]=h}catch(A){for(A instanceof Error?console.warn("[".concat(A.message,']: Received "').concat(typeof h,'" instead with value, ').concat(JSON.stringify(h))):console.warn("".concat(JSON.stringify(h),' received in <ThreeDot variant="bob" /> indicator cannot be processed. Using default instead!')),x=0;x<bi.length;x++)m[bi[x]]=no}return m}((i=n==null?void 0:n.color)!==null&&i!==void 0?i:"");return bt.createElement("span",{className:"rli-d-i-b bob-rli-bounding-box",style:xt(xt(xt(xt(xt({},u&&{fontSize:u}),d&&{"--rli-animation-duration":d}),f&&{"--rli-animation-function":f}),p),l),role:"status","aria-live":"polite","aria-label":"Loading"},bt.createElement("span",{className:"bob-indicator"},bt.createElement("span",{className:"bobbing"})),bt.createElement(Zl,{staticText:!0,text:n==null?void 0:n.text,textColor:n==null?void 0:n.textColor}))};Kt(`.bounce-rli-bounding-box {
...
}`);var xi=Array.from({length:4},function(n,i){return"--TD-bounce-phase".concat(i+1,"-color")}),KA=function(n){var i,o=Gl(n==null?void 0:n.style,n==null?void 0:n.size),l=o.styles,u=o.fontSize,f=n==null?void 0:n.easing,d=Xl(n==null?void 0:n.speedPlus,"0.5s").animationPeriod,p=function(h){var m={};if(h instanceof Array){for(var v=Kl(h,xi.length),b=0;b<v.length&&!(b>=4);b++)m[xi[b]]=v[b];return m}try{if(typeof h!="string")throw new Error("Color String expected");for(var x=0;x<xi.length;x++)m[xi[x]]=h}catch{for(x=0;x<xi.length;x++)m[xi[x]]=no}return m}((i=n==null?void 0:n.color)!==null&&i!==void 0?i:"");return bt.createElement("span",{className:"rli-d-i-b bounce-rli-bounding-box",style:xt(xt(xt(xt(xt({},u&&{fontSize:u}),d&&{"--rli-animation-duration":d}),f&&{"--rli-animation-function":f}),p),l)},bt.createElement("span",{className:"wrapper"},bt.createElement("span",{className:"group"},bt.createElement("span",{className:"rli-d-i-b dot"}),bt.createElement("span",{className:"rli-d-i-b dot"}),bt.createElement("span",{className:"rli-d-i-b dot"})),bt.createElement("span",{className:"group"},bt.createElement("span",{className:"rli-d-i-b shadow"}),bt.createElement("span",{className:"rli-d-i-b shadow"}),bt.createElement("span",{className:"rli-d-i-b shadow"}))),bt.createElement(Zl,{staticText:!0,text:n==null?void 0:n.text,textColor:n==null?void 0:n.textColor,style:{marginTop:"2px"}}))},QA=function(n){var i=Object(n).variant,o=i===void 0?"pulsate":i;return o==="pulsate"?bt.createElement(XA,xt({},n)):o==="brick-stack"?bt.createElement(GA,xt({},n)):o==="bob"?bt.createElement(ZA,xt({},n)):o==="bounce"?bt.createElement(KA,xt({},n)):null};Kt(`.blink-blur-rli-bounding-box {
...
}`);Array.from({length:4},function(n,i){return"--life-line-phase".concat(i+1,"-color")});const FA=()=>{const[n,i]=_.useState(0),[o,l]=_.useState(!1),u=async()=>{l(!0);try{const p=await fetch("https://vdjt.jordy-server.my.id:5000/last-row");if(!p.ok)throw new Error("Response error");const h=await p.json();i(h[0])}catch(p){console.error("Error fetching data:",p)}l(!1)};_.useEffect(()=>{u()},[]);const f=async()=>{try{l(!0);const p=await fetch("https://vdjt.jordy-server.my.id:5000/increase",{method:"POST",headers:{"Content-Type":"application/json"}}),h=await p.json();if(!p.ok)throw new Error(h.error||"Something went wrong");i(Number(n)+1),l(!1)}catch(p){console.error(p)}},d=async()=>{try{l(!0);const p=await fetch("https://vdjt.jordy-server.my.id:5000/decrease",{method:"POST",headers:{"Content-Type":"application/json"}}),h=await p.json();if(!p.ok)throw new Error(h.error||"Something went wrong");i(Number(n)+1),l(!1)}catch(p){console.error(p)}};return Lt.jsxs("div",{className:"flex flex-col items-center justify-items-center p-10 h-full",children:[o&&Lt.jsx(QA,{variant:"bounce",color:"#31b7cc",size:"medium",text:"Sabar Ya",textColor:""}),!o&&Lt.jsxs("div",{children:[Lt.jsx("button",{onClick:f,className:"my-4 bg-sky-500 px-4 py-2 rounded-lg hover:bg-sky-600 text-white w-full",children:"+"}),Lt.jsx("div",{className:"flex flex-row space-x-4 p-4 bg-gray-800 rounded-lg w-fit",children:Lt.jsx("div",{className:"text-6xl font-bold text-white w-fit text-center",children:String(n).padStart(3,"0")})}),Lt.jsx("button",{onClick:d,disabled:n<=0,className:"my-4 bg-red-400 px-4 py-2 rounded-lg hover:bg-red-500 text-white w-full",children:"-"})]})]})},JA=()=>Lt.jsx(Px,{children:Lt.jsxs(yx,{children:[Lt.jsx(Oc,{path:"/",element:Lt.jsx(RA,{})}),Lt.jsx(Oc,{path:"/manage",element:Lt.jsx(FA,{})})]})});M1.createRoot(document.getElementById("root")).render(Lt.jsx(_.StrictMode,{children:Lt.jsx(JA,{})}));
